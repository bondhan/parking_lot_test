...
func (s store) GetRegistrationsByColor() schema.CMDStore {
	return s.info
}

func (s store) GetSlotsByColor() schema.CMDStore {
	return s.info
}

func (s store) GetASlotByRegNo() schema.CMDStore {
	return s.info
}
